...
## Projector CPE update

The three critical patients now use different patient-specific CPE pathways:

- Marie Svobodova / post-CABG hypovolemia: BUN -> volume depletion -> creatinine -> AKI.
- Jan Novak / pneumonia septic shock: lactate -> septic hypoperfusion -> creatinine -> AKI.
- Petr Dvorak / polytrauma rhabdomyolysis: CK/myoglobin -> pigment nephropathy -> creatinine -> AKI.

The causal pathway diagram no longer includes the explanatory legend under the arrows. Timing labels now use plain language such as "change appears after ~3 h" and "AKI risk rises ~2 h later" instead of ambiguous short lag labels.
