...
import { FileText, Globe, Download, Mail, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-surface-50 via-white to-brand-50">
      ...
      <main className="max-w-7xl mx-auto px-6 pt-8 pb-16 sm:pt-12">
        ...
        <motion.div
          ...
          className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto"
        >
          {[
