import { TemplateConfig, ContentMode } from '@/types';
import { getTemplate } from './configs';
import { formatDate, sortByDate, sortEducationByDate } from '@/lib/utils';

function detectContentMode(data: any, config: TemplateConfig): ContentMode {
...
export function renderResumeHtml(data: any, forExport = false): string {
