...
export async function generateCvDocx(data: any, options: DocxOptions): Promise<Buffer> {
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function generateCoverLetterDocx(data: any, options: DocxOptions): Promise<Buffer> {
