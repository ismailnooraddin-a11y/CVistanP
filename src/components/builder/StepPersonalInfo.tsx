...
export default function StepPersonalInfo() {
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      {/* Photo upload - stores as data URL for guest mode */}
      {/* For production with user accounts, use Supabase Storage */}
      <div>
                ...
                onChange={(e) => {
                  ...
                  if (file) {
                    ...
                    if (file.size > 2 * 1024 * 1024) {
                      alert(lang === 'ar' ? 'حجم الملف كبير جداً. الحد الأقصى 2MB.' : 'File too large. Max size is 2MB.');
                      return;
                    }
        ...
        <p className="text-xs text-surface-400 mt-2">
          {lang === 'ar' ? 'صورتك محفوظة محلياً. للاحتفاظ بها دائماً، أنشئ حساباً.' : 'Your photo is stored locally. To keep it permanently, create an account.'}
        </p>
      </div>
